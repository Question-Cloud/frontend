    ...
    return (
      <div className="w-full">
        ...
        <input
          type={type}
          className={cn(
            "flex h-[48px] w-full rounded-[8px] border bg-white px-[20px] py-[12px] text-body2 placeholder:text-gray_03 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50",
